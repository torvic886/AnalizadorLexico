...
class Variable(var nombre: Token, var tipoDato: Token, var operadorAsignacion: Token?, var expresion: Expresion3?, var invFuncion: SentenciaInvocacionFuncion3?) : Sentencia3() {
